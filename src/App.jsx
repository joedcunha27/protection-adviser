...
${hasPartner?`PARTNER: ${partner.firstName} | DOB: ${partner.dob} (Age: ${pAge??'unknown'}) | Gender: ${partner.gender} | Smoker: ${partner.smoker}
...
Sick pay: ${partner.employerSickPay||'unknown'} for ${partner.employerSickPayDuration||'unknown'}
Health: ${partner.healthDetails||'Nothing disclosed'}`:'PARTNER: None'}

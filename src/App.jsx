...
1. EXISTING COVER ASSESSMENT - assess each policy: gaps, what to replace or keep. If none: state “No existing cover.”
1. UNDERWRITING QUESTIONS - specific questions to ask based on health disclosures, BMI, occupation, lifestyle.
1. UNDERWRITING FLAGS - direct flags for loadings, exclusions, postponement or decline risks.
...
${hasPartner?`PARTNER: ${partner.firstName} | DOB: ${partnerDOB} (Age: ${partnerAge??'unknown'}, State Pension Age: ${partnerSPA??'unknown'}) | Gender: ${partner.gender} | Smoker: ${partner.smoker} Height: ${pHeightCm.toFixed(0)}cm | Weight: ${pWeightKg.toFixed(1)}kg${pb} Occupation: ${partner.occupation} (${partner.employmentType}) | Gross: £${partner.grossIncome}/yr | Take-home: £${partner.takeHomePay}/month ${pSick} Health: ${partner.healthDetails||'Nothing disclosed'}`:‘PARTNER: None / single’}
